...
@Database(entities = {Setting.class, Hotel.class, Category.class, Service.class, Media.class, Offer.class, Testimonial.class, Arrival.class, Sale.class, Device.class, Analytics.class}, version = 3, exportSchema = false)
