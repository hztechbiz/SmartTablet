...
public class CategoryGridAdapter extends BaseAdapter {
    ...
    private List<com.smart.tablet.entities.Category> categories;
    private Context context;
    private LayoutInflater inflater;

    public CategoryGridAdapter(Context context, List<com.smart.tablet.entities.Category> categories, View.OnClickListener itemClickListener) {
    ...
    @Override
    public com.smart.tablet.entities.Category getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        com.smart.tablet.entities.Category category = getItem(position);
