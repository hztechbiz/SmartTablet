...
public class StoreOffer extends AsyncTask<Void, Void, Boolean> {
    ...
    public com.smart.tablet.tasks.StoreOffer onError(AsyncResultBag.Error callback) {
        _errorCallback = callback;
        return this;
    }

    public com.smart.tablet.tasks.StoreOffer beforeExecuting(AsyncResultBag.Before callback) {
        _beforeCallback = callback;
        return this;
    }

    public com.smart.tablet.tasks.StoreOffer onSuccess(AsyncResultBag.Success callback) {
