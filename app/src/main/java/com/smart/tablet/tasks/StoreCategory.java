...
public class StoreCategory extends AsyncTask<Void, Void, Boolean> {
    ...
    public com.smart.tablet.tasks.StoreCategory onError(AsyncResultBag.Error callback) {
        _errorCallback = callback;
        return this;
    }

    public com.smart.tablet.tasks.StoreCategory beforeExecuting(AsyncResultBag.Before callback) {
        _beforeCallback = callback;
        return this;
    }

    public com.smart.tablet.tasks.StoreCategory onSuccess(AsyncResultBag.Success callback) {
