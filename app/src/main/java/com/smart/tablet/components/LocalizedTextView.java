...
public class LocalizedTextView extends AppCompatTextView {
    ...
    private BroadcastReceiver languageChangeReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (_language_code.equals(Constants.DEFAULT_LANG)) {
                setText(_actual_text);
            } else {
    ...
    public LocalizedTextView(Context context, AttributeSet attrs, int defStyleAttr) {
