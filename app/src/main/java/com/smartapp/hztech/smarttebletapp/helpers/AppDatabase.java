...
@Database(entities = {Setting.class, Hotel.class, Category.class, Service.class, Media.class, Offer.class, Testimonial.class, Arrival.class, Sale.class}, version = 27, exportSchema = false)
